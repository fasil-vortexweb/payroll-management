        ...
        <table id="employeeTable" class="table table-bordered table-hover" style="width:100%">
            ...
            <tbody>
                ...
                foreach ($employees as $employee) {
                    ...
                    echo "<tr>
                        <td>{$employee['ufCrm40_1726316965739']}</td>
                        <td>{$employee['ufCrm40_1726316974380']}</td>
                        
                        <td>{$employee['ufCrm40_1726317122244']}</td>
                        <td>
                            <form id='payslipForm{$employee['ufCrm40_1726316974380']}' action='payslip.php' method='POST' target='_blank'>
                                <input type='hidden' name='employeeId' value='{$employee['ufCrm40_1726316974380']}'>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit-btn').click(async function() {
                ...
                await fetch('https://b24-g51s9r.bitrix24.com/rest/8/6596tfx7g78yi7p1/crm.item.get.json?entityTypeId=1114&id=' + Number(editEmployeeId))
                    .then(response => response.json())
                    .then(data => data.result.item)
                    .then(item => {
                        console.log(item)
                        document.getElementById('editEmployeeName').value = item.ufCrm40_1726316965739;
                        document.getElementById('editEmployeeSalary').value = item.ufCrm40_1726317122244;

                        document.getElementById('editEmployeeBasic').value = item.ufCrm40_1726317023423;
                        document.getElementById('editEmployeeTds').value = item.ufCrm40_1726317034173;
                        document.getElementById('editEmployeeDa').value = item.ufCrm40_1726317043138;
                        document.getElementById('editEmployeeEsi').value = item.ufCrm40_1726317049030;
                        document.getElementById('editEmployeeHra').value = item.ufCrm40_1726317056585;
                        document.getElementById('editEmployeePf').value = item.ufCrm40_1726317064611;
                        document.getElementById('editEmployeeConveyance').value = item.ufCrm40_1726317073737;
                        document.getElementById('editEmployeeLeave').value = item.ufCrm40_1726317080335;
                        document.getElementById('editEmployeeAllowance').value = item.ufCrm40_1726317091326;
                        document.getElementById('editEmployeeProfTax').value = item.ufCrm40_1726317099237;
                        document.getElementById('editEmployeeMedicalAllowance').value = item.ufCrm40_1726317106914;
                        document.getElementById('editEmployeeLabourWelfare').value = item.ufCrm40_1726317115510;
